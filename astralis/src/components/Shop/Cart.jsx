...
const Cart = ({
  ...
  const total = (arr) => {
    ...
    }, 0); // 0 is the initial size of total money
  };
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white w-[180px] sm:w-[250px] h-full absolute right-0 overflow-y-scroll scrollbar-hide animate-fade-in mt-16"
      >
        ...
        <div className="flex flex-col items-center px-2 py-4">
          ...
          {cart.length > 0 && <p>Total: {Euro.format(total(cart))} </p>}
        </div>
      </div>
    </div>
  );
